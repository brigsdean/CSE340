-- This script is used to initialize the database for the CSE Motors application.
-- It creates the necessary tables, types, and constraints.
...
-- This table stores the inventory of vehicles available for sale.
-- It includes details such as make, model, year, description, image, thumbnail, price, miles, color, and classification.
...
-- Create relationships between inventory and classification tables
-- This section establishes foreign key constraints to ensure data integrity.
...
-- This table stores the account information for users of the system.
...
-- This section inserts initial values into the classification table.
...
-- This section inserts initial values into the inventory table.
