...
rebuild database scrypt

**********************************************************************/

-- create type and tables
...
ADD CONSTRAINT fk_myclassification FOREIGN KEY (classification_id)
...
fill database with data inventary-data
...
Adjuste a few data  from task 1
